...
//     string public constant name = "Wrapped Gen 0";
//     string public constant symbol = "WG0";
...
//     function depositKittiesAndMintTokens(uint256[] calldata _kittyIds)
//         external
//         nonReentrant
//     {
//         require(
//             _kittyIds.length > 0,
//             "you must submit an array with at least one element"
//         );
...
//             (, , kittyCooldown, , , , , , kittyGen, ) = kittyCore.getKitty(
//                 kittyToDeposit
//             );

//             require(
//                 msg.sender == kittyCore.ownerOf(kittyToDeposit),
//                 "you do not own this cat"
//             );
//             require(
//                 kittyCore.kittyIndexToApproved(kittyToDeposit) == address(this),
//                 "you must approve() this contract before you can deposit a cat"
//             );
...
//         require(
//             _kittyIds.length == _destinationAddresses.length,
//             "you did not provide a destination address for each of the cats you wish to withdraw"
//         );
//         require(
//             _kittyIds.length > 0,
//             "you must submit an array with at least one element"
...
//         require(
//             balanceOf(msg.sender) >= numTokensToBurn.mul(10**18),
//             "you do not own enough tokens to withdraw this many ERC721 cats"
//         );
...
//             } else {
//                 require(
//                     kittyIsDepositedInContract[kittyToWithdraw] == true,
//                     "this kitty has already been withdrawn"
//                 );
//                 require(
//                     address(this) == kittyCore.ownerOf(kittyToWithdraw),
//                     "the contract does not own this cat"
//                 );
...
//         require(
//             depositedKittiesArray.length > 0,
//             "there are no cats in the array"
//         );
//         uint256 kittyId = depositedKittiesArray[depositedKittiesArray.length -
//             1];
...
//     function batchRemoveWithdrawnKittiesFromStorage(uint256 _numSlotsToCheck)
//         external
//     {
//         require(
//             _numSlotsToCheck <= depositedKittiesArray.length,
//             "you are trying to batch remove more slots than exist in the array"
//         );
//         uint256 arrayIndex = depositedKittiesArray.length;
//         for (uint256 i = 0; i < _numSlotsToCheck; i++) {
